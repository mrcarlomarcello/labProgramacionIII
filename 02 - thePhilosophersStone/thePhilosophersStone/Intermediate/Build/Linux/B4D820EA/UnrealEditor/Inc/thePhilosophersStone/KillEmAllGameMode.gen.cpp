...
#include "thePhilosophersStone/KillEmAllGameMode.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeKillEmAllGameMode() {}
// Cross Module References
	THEPHILOSOPHERSSTONE_API UClass* Z_Construct_UClass_AKillEmAllGameMode_NoRegister();
	THEPHILOSOPHERSSTONE_API UClass* Z_Construct_UClass_AKillEmAllGameMode();
...
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AKillEmAllGameMode_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_ASimpleShootingGameModeBase,
	...
	template<> THEPHILOSOPHERSSTONE_API UClass* StaticClass<AKillEmAllGameMode>()
	{
		return AKillEmAllGameMode::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AKillEmAllGameMode);
	struct Z_CompiledInDeferFile_FID_thePhilosophersStone_Source_thePhilosophersStone_KillEmAllGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_thePhilosophersStone_Source_thePhilosophersStone_KillEmAllGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AKillEmAllGameMode, AKillEmAllGameMode::StaticClass, TEXT("AKillEmAllGameMode"), &Z_Registration_Info_UClass_AKillEmAllGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AKillEmAllGameMode), 3669645379U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_thePhilosophersStone_Source_thePhilosophersStone_KillEmAllGameMode_h_1824256771(TEXT("/Script/thePhilosophersStone"),
		Z_CompiledInDeferFile_FID_thePhilosophersStone_Source_thePhilosophersStone_KillEmAllGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_thePhilosophersStone_Source_thePhilosophersStone_KillEmAllGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
