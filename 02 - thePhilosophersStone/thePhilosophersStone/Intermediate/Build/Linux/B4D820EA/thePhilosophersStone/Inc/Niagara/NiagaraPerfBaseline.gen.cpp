...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraPerfBaselineStats>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraPerfBaseline_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_ANiagaraPerfBaselineActor, ANiagaraPerfBaselineActor::StaticClass, TEXT("ANiagaraPerfBaselineActor"), &Z_Registration_Info_UClass_ANiagaraPerfBaselineActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANiagaraPerfBaselineActor), 3882459292U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraPerfBaseline_h_814244592(TEXT("/Script/Niagara"),
