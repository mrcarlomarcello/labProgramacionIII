...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimTrack>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCompositeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimCompositeBase, UAnimCompositeBase::StaticClass, TEXT("UAnimCompositeBase"), &Z_Registration_Info_UClass_UAnimCompositeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimCompositeBase), 754446269U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCompositeBase_h_3134761703(TEXT("/Script/Engine"),
