...
template<> ENGINE_API UScriptStruct* StaticStruct<FViewTargetTransitionParams>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_PlayerCameraManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APlayerCameraManager, APlayerCameraManager::StaticClass, TEXT("APlayerCameraManager"), &Z_Registration_Info_UClass_APlayerCameraManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APlayerCameraManager), 1673968179U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_PlayerCameraManager_h_263743779(TEXT("/Script/Engine"),
