...
template<> ENGINE_API UScriptStruct* StaticStruct<FHLODInstancingKey>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LODActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALODActor, ALODActor::StaticClass, TEXT("ALODActor"), &Z_Registration_Info_UClass_ALODActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALODActor), 3543199469U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LODActor_h_1702074684(TEXT("/Script/Engine"),
