...
template<> ENGINE_API UScriptStruct* StaticStruct<FTentDistribution>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SkyAtmosphereComponent_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_ASkyAtmosphere, ASkyAtmosphere::StaticClass, TEXT("ASkyAtmosphere"), &Z_Registration_Info_UClass_ASkyAtmosphere, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASkyAtmosphere), 36992933U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SkyAtmosphereComponent_h_2101872605(TEXT("/Script/Engine"),
