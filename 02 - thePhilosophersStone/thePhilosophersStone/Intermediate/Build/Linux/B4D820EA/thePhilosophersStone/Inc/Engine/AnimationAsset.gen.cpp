...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimationGroupReference>()
{
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAnimationAsset_SetPreviewSkeletalMesh, "SetPreviewSkeletalMesh" }, // 65290984
#endif //WITH_EDITOR
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimationAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimationAsset, UAnimationAsset::StaticClass, TEXT("UAnimationAsset"), &Z_Registration_Info_UClass_UAnimationAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimationAsset), 1559729525U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimationAsset_h_3821445662(TEXT("/Script/Engine"),
