...
template<> NAVIGATIONSYSTEM_API UScriptStruct* StaticStruct<FRecastNavMeshTileGenerationDebug>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavMesh_RecastNavMesh_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ARecastNavMesh, ARecastNavMesh::StaticClass, TEXT("ARecastNavMesh"), &Z_Registration_Info_UClass_ARecastNavMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARecastNavMesh), 2717496101U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavMesh_RecastNavMesh_h_3432665506(TEXT("/Script/NavigationSystem"),
