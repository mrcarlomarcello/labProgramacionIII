...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimMontageInstance>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimMontage_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimMontage, UAnimMontage::StaticClass, TEXT("UAnimMontage"), &Z_Registration_Info_UClass_UAnimMontage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimMontage), 1849323348U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimMontage_h_3249707651(TEXT("/Script/Engine"),
