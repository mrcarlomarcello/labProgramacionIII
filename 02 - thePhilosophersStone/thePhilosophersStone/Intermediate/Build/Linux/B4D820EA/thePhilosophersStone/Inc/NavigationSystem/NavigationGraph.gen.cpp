...
template<> NAVIGATIONSYSTEM_API UScriptStruct* StaticStruct<FNavGraphNode>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavGraph_NavigationGraph_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANavigationGraph, ANavigationGraph::StaticClass, TEXT("ANavigationGraph"), &Z_Registration_Info_UClass_ANavigationGraph, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavigationGraph), 2974899155U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavGraph_NavigationGraph_h_2859632700(TEXT("/Script/NavigationSystem"),
