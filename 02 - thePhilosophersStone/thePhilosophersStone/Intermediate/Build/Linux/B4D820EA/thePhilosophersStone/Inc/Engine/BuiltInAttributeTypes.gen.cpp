...
template<> ENGINE_API UScriptStruct* StaticStruct<FNonBlendableIntegerAnimationAttribute>()
{
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UBuiltInAttributesExtensions_AddTransformAttribute, "AddTransformAttribute" }, // 80280056
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BuiltInAttributeTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBuiltInAttributesExtensions, UBuiltInAttributesExtensions::StaticClass, TEXT("UBuiltInAttributesExtensions"), &Z_Registration_Info_UClass_UBuiltInAttributesExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBuiltInAttributesExtensions), 888126695U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BuiltInAttributeTypes_h_2671663559(TEXT("/Script/Engine"),
