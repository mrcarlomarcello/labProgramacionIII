...
template<> ENGINE_API UScriptStruct* StaticStruct<FCullDistanceSizePair>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CullDistanceVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACullDistanceVolume, ACullDistanceVolume::StaticClass, TEXT("ACullDistanceVolume"), &Z_Registration_Info_UClass_ACullDistanceVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACullDistanceVolume), 1097238238U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CullDistanceVolume_h_394872280(TEXT("/Script/Engine"),
