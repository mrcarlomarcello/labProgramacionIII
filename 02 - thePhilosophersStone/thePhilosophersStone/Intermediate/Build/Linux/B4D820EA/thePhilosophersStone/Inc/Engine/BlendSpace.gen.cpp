...
template<> ENGINE_API UScriptStruct* StaticStruct<FPerBoneInterpolation>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BlendSpace_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UBlendSpace, UBlendSpace::StaticClass, TEXT("UBlendSpace"), &Z_Registration_Info_UClass_UBlendSpace, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlendSpace), 396633067U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BlendSpace_h_3543210203(TEXT("/Script/Engine"),
