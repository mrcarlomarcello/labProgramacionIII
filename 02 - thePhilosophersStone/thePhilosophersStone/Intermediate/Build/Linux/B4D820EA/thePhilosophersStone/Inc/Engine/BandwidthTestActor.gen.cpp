...
template<> ENGINE_API UScriptStruct* StaticStruct<FBandwidthTestGenerator>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Net_BandwidthTestActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABandwidthTestActor, ABandwidthTestActor::StaticClass, TEXT("ABandwidthTestActor"), &Z_Registration_Info_UClass_ABandwidthTestActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABandwidthTestActor), 991968065U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Net_BandwidthTestActor_h_643632621(TEXT("/Script/Engine"),
