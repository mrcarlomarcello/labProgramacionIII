...
template<> ENGINE_API UScriptStruct* StaticStruct<FAssetImportInfo>()
{
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAssetImportData_K2_ExtractFilenames, "K2_ExtractFilenames" }, // 2258702618
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAssetImportData_K2_GetFirstFilename, "K2_GetFirstFilename" }, // 1957348680
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAssetImportData_ScriptedAddFilename, "ScriptedAddFilename" }, // 1388421879
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_EditorFramework_AssetImportData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetImportData, UAssetImportData::StaticClass, TEXT("UAssetImportData"), &Z_Registration_Info_UClass_UAssetImportData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetImportData), 855260460U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_EditorFramework_AssetImportData_h_2158332177(TEXT("/Script/Engine"),
