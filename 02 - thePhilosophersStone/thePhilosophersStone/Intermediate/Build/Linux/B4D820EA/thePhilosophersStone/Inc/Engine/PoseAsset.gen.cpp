...
template<> ENGINE_API UScriptStruct* StaticStruct<FPoseDataContainer>()
{
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UPoseAsset_GetPoseNames, "GetPoseNames" }, // 2027691178
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UPoseAsset_RenamePose, "RenamePose" }, // 1328806828
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UPoseAsset_UpdatePoseFromAnimation, "UpdatePoseFromAnimation" }, // 2274424481
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_PoseAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPoseAsset, UPoseAsset::StaticClass, TEXT("UPoseAsset"), &Z_Registration_Info_UClass_UPoseAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseAsset), 242243858U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_PoseAsset_h_1379409081(TEXT("/Script/Engine"),
