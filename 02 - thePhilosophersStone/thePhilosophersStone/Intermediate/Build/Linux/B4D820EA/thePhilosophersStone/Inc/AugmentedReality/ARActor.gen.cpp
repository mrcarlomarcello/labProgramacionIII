...
template<> AUGMENTEDREALITY_API UScriptStruct* StaticStruct<FTrackedGeometryGroup>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AARActor, AARActor::StaticClass, TEXT("AARActor"), &Z_Registration_Info_UClass_AARActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AARActor), 4108215116U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARActor_h_4073266752(TEXT("/Script/AugmentedReality"),
