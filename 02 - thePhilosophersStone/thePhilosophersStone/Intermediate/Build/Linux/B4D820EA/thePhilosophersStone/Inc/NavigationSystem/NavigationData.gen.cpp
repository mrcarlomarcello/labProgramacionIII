...
template<> NAVIGATIONSYSTEM_API UScriptStruct* StaticStruct<FSupportedAreaData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavigationData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANavigationData, ANavigationData::StaticClass, TEXT("ANavigationData"), &Z_Registration_Info_UClass_ANavigationData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavigationData), 579587907U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavigationData_h_939940007(TEXT("/Script/NavigationSystem"),
