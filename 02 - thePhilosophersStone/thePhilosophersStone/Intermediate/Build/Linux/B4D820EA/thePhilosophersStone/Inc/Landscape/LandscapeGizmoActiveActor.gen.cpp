...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FGizmoSelectData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGizmoActiveActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALandscapeGizmoActiveActor, ALandscapeGizmoActiveActor::StaticClass, TEXT("ALandscapeGizmoActiveActor"), &Z_Registration_Info_UClass_ALandscapeGizmoActiveActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALandscapeGizmoActiveActor), 2407384608U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGizmoActiveActor_h_3262594131(TEXT("/Script/Landscape"),
