...
template<> ENGINE_API UScriptStruct* StaticStruct<FBasedMovementInfo>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_Character_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACharacter, ACharacter::StaticClass, TEXT("ACharacter"), &Z_Registration_Info_UClass_ACharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACharacter), 1670618945U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_Character_h_976837318(TEXT("/Script/Engine"),
