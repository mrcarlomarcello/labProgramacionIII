...
template<> ENGINE_API UScriptStruct* StaticStruct<FInteriorSettings>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_AudioVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AAudioVolume, AAudioVolume::StaticClass, TEXT("AAudioVolume"), &Z_Registration_Info_UClass_AAudioVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAudioVolume), 2575314587U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_AudioVolume_h_2194683208(TEXT("/Script/Engine"),
