...
template<> TEMPLATESEQUENCE_API UScriptStruct* StaticStruct<FTemplateSequenceBindingOverrideData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_TemplateSequenceActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATemplateSequenceActor, ATemplateSequenceActor::StaticClass, TEXT("ATemplateSequenceActor"), &Z_Registration_Info_UClass_ATemplateSequenceActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATemplateSequenceActor), 3007475972U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_TemplateSequenceActor_h_2431617980(TEXT("/Script/TemplateSequence"),
