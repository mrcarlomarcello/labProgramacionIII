...
template<> AUGMENTEDREALITY_API UScriptStruct* StaticStruct<FARSharedWorldReplicationState>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARSharedWorldGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AARSharedWorldGameMode, AARSharedWorldGameMode::StaticClass, TEXT("AARSharedWorldGameMode"), &Z_Registration_Info_UClass_AARSharedWorldGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AARSharedWorldGameMode), 1248482243U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARSharedWorldGameMode_h_744976269(TEXT("/Script/AugmentedReality"),
