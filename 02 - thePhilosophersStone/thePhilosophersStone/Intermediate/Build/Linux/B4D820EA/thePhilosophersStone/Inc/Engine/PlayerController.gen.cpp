...
template<> ENGINE_API UScriptStruct* StaticStruct<FUpdateLevelStreamingLevelStatus>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_PlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APlayerController, APlayerController::StaticClass, TEXT("APlayerController"), &Z_Registration_Info_UClass_APlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APlayerController), 2248875348U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_PlayerController_h_2162500302(TEXT("/Script/Engine"),
