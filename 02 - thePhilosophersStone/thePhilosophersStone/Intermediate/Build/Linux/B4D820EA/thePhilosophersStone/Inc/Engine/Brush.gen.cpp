...
template<> ENGINE_API UScriptStruct* StaticStruct<FGeomSelection>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Brush_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABrush, ABrush::StaticClass, TEXT("ABrush"), &Z_Registration_Info_UClass_ABrush, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABrush), 304406460U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Brush_h_2404476299(TEXT("/Script/Engine"),
