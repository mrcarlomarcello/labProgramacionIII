...
template<> CINEMATICCAMERA_API UScriptStruct* StaticStruct<FCameraLookatTrackingSettings>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_CinematicCamera_Public_CineCameraActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACineCameraActor, ACineCameraActor::StaticClass, TEXT("ACineCameraActor"), &Z_Registration_Info_UClass_ACineCameraActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACineCameraActor), 4247999740U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_CinematicCamera_Public_CineCameraActor_h_1403325112(TEXT("/Script/CinematicCamera"),
