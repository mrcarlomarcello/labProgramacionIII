...
template<> ENGINE_API UScriptStruct* StaticStruct<FBroadphaseSettings>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_WorldSettings_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_AWorldSettings, AWorldSettings::StaticClass, TEXT("AWorldSettings"), &Z_Registration_Info_UClass_AWorldSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWorldSettings), 1118598438U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_WorldSettings_h_1495434986(TEXT("/Script/Engine"),
